...
import 'package:untitled2/quiz/brasil/quiz_brasil_3.dart';
import 'package:untitled2/quiz/estados%20unidos/quiz_usa_3.dart';
import '../../funcionalidades/exitalert.dart';
import '../0firestore/firestore_services.dart';

class QuizUsa2 extends StatefulWidget {


  @override
  _QuizUsa2State createState() => _QuizUsa2State();
}
class _QuizUsa2State extends State<QuizUsa2> {
  ...
  void _onVerifyAnswer() async {
    ...
    if (await firestoreService.isQuestionAnswered(userId, "usaQuiz", "Qual a maior cidade dos Estados Unidos?")) {
      setState(() {
        _feedbackMessage = 'Você já respondeu essa pergunta corretamente antes!';
        Future.delayed(const Duration(seconds: 3), () async{
          Navigator.pushReplacement(
            context,
            MaterialPageRoute(builder: (context) => QuizUsa3()),
          );
        }
        );
      });
    ...
    if (_userAnswer.trim().toLowerCase() == 'nova york') {
      setState(() {
      ...
      firestoreService.markQuestionAsAnswered(userId, "usaQuiz", "Qual a maior cidade dos Estados Unidos?");
      ...
      setState(() {
        _feedbackMessage = 'Resposta correta: Nova York';
            ...
            child: Column(
              ...
              children: [
                ...
                Padding(
                  ...
                  child: Center(child: Text('Qual a maior cidade dos Estados Unidos?',
