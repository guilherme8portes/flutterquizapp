...
import 'package:untitled2/quiz/estados%20unidos/quiz_usa_2.dart';
import '../../funcionalidades/exitalert.dart';
import '../0firestore/firestore_services.dart';

class QuizUsa1 extends StatefulWidget {


  @override
  _QuizUsa1State createState() => _QuizUsa1State();
}
class _QuizUsa1State extends State<QuizUsa1> {
  ...
  void _onVerifyAnswer() async {
    ...
    if (await firestoreService.isQuestionAnswered(userId, "usaQuiz", "Qual a Capital dos Estados Unidos?")) {
      setState(() {
        _feedbackMessage = 'Você já respondeu essa pergunta corretamente antes!';
        Future.delayed(const Duration(seconds: 3), () async{
          Navigator.pushReplacement(
            context,
            MaterialPageRoute(builder: (context) => QuizUsa2()),
          );
        }
        );
      });
    ...
    if (_userAnswer.trim().toLowerCase() == 'washington d.c.') {
      setState(() {
      ...
      firestoreService.markQuestionAsAnswered(userId, "usaQuiz", "Qual a Capital dos Estados Unidos?");
      ...
      setState(() {
        _feedbackMessage = 'Resposta correta: Washington D.C.';
            ...
            child: Column(
              ...
              children: [
                ...
                Padding(
                  ...
                  child: Center(child: Text('Qual a capital dos Estados Unidos?',
