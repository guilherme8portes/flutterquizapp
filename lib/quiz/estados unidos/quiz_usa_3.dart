...
import 'package:untitled2/quiz/estados%20unidos/quzi_usa_4.dart';
import '../../funcionalidades/exitalert.dart';
import '../0firestore/firestore_services.dart';

class QuizUsa3 extends StatefulWidget {


  @override
  _QuizUsa3State createState() => _QuizUsa3State();
}
class _QuizUsa3State extends State<QuizUsa3> {
  ...
  void _onVerifyAnswer() async {
    ...
    if (await firestoreService.isQuestionAnswered(userId, "usaQuiz", "Qual a empresa mais valiosa dos Estados Unidos?")) {
      setState(() {
        _feedbackMessage = 'Você já respondeu essa pergunta corretamente antes!';
        Future.delayed(const Duration(seconds: 3), () async{
          Navigator.pushReplacement(
            context,
            MaterialPageRoute(builder: (context) => QuizUsa4()),
          );
        }
        );
      });
    ...
    if (_userAnswer.trim().toLowerCase() == 'apple') {
      setState(() {
      ...
      firestoreService.markQuestionAsAnswered(userId, "usaQuiz", "Qual a empresa mais valiosa dos Estados Unidos?");
      ...
      setState(() {
        _feedbackMessage = 'Resposta correta: Apple';
            ...
            child: Column(
              ...
              children: [
                ...
                Padding(
                  ...
                  child: Center(child: Text('Qual a empresa mais valiosa dos USA?',
