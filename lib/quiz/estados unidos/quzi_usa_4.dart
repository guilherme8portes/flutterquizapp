...
import 'package:untitled2/quiz/estados%20unidos/quiz_usa_5.dart';
import '../../funcionalidades/exitalert.dart';
import '../0firestore/firestore_services.dart';

class QuizUsa4 extends StatefulWidget {


  @override
  _QuizUsa4State createState() => _QuizUsa4State();
}
class _QuizUsa4State extends State<QuizUsa4> {
  ...
  void _onVerifyAnswer() async {
    ...
    if (await firestoreService.isQuestionAnswered(userId, "usaQuiz", "Qual a população dos Estados Unidos?")) {
      setState(() {
        _feedbackMessage = 'Você já respondeu essa pergunta corretamente antes!';
        Future.delayed(const Duration(seconds: 3), () async{
          Navigator.pushReplacement(
            context,
            MaterialPageRoute(builder: (context) => QuizUsa5()),
          );
        }
        );
      });
    ...
    if (_userAnswer.trim().toLowerCase() == '330 milhões') {
      setState(() {
      ...
      firestoreService.markQuestionAsAnswered(userId, "usaQuiz", "Qual a população dos Estados Unidos?");
      ...
      setState(() {
        _feedbackMessage = 'Resposta correta: 330 milhões';
            ...
            child: Column(
              ...
              children: [
                ...
                Padding(
                  ...
                  child: Center(child: Text('Qual a população dos Estados Unidos?',
