...
class LessonsResultsUsa extends StatefulWidget {
  const LessonsResultsUsa({Key? key}) : super(key: key);

  @override
  State<LessonsResultsUsa> createState() => _LessonsResultsUsaState();
}

class _LessonsResultsUsaState extends State<LessonsResultsUsa> {
            ...
            child: Column(
              ...
              children: [
                ...
                Padding(
                  ...
                  child: Center(child: Text('Parabens, você concluiu o Quiz Estados Unidos!',
