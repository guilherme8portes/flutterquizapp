...
import 'package:untitled2/quiz/fran%C3%A7a/quiz_franca_3.dart';
import '../../funcionalidades/exitalert.dart';
import '../0firestore/firestore_services.dart';

class QuizFranca2 extends StatefulWidget {


  @override
  _QuizFranca2State createState() => _QuizFranca2State();
}
class _QuizFranca2State extends State<QuizFranca2> {
  ...
  void _onVerifyAnswer() async {
    ...
    if (await firestoreService.isQuestionAnswered(userId, "françaQuiz", "Qual a maior cidade da França?")) {
      setState(() {
        _feedbackMessage = 'Você já respondeu essa pergunta corretamente antes!';
        Future.delayed(const Duration(seconds: 3), () async{
          Navigator.pushReplacement(
            context,
            MaterialPageRoute(builder: (context) => QuizFranca3()),
          );
        }
        );
      });
    ...
    if (_userAnswer.trim().toLowerCase() == 'paris') {
      setState(() {
      ...
      firestoreService.markQuestionAsAnswered(userId, "françaQuiz", "Qual a maior cidade da França?");
      ...
      setState(() {
        _feedbackMessage = 'Resposta correta: Paris';
            ...
            child: Column(
              ...
              children: [
                ...
                Padding(
                  ...
                  child: Center(child: Text('Qual a maior cidade da França?',
