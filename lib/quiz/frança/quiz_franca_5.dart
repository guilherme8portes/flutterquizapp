...
import 'package:untitled2/quiz/fran%C3%A7a/lesson_results_fran%C3%A7a.dart';
import '../../funcionalidades/exitalert.dart';
import '../0firestore/firestore_services.dart';

class QuizFranca5 extends StatefulWidget {


  @override
  _QuizFranca5State createState() => _QuizFranca5State();
}
class _QuizFranca5State extends State<QuizFranca5> {
  ...
  void _onVerifyAnswer() async {
    ...
    if (await firestoreService.isQuestionAnswered(userId, "françaQuiz", "Qual o PIB da França?")) {
      setState(() {
        _feedbackMessage = 'Você já respondeu essa pergunta corretamente antes!';
        Future.delayed(const Duration(seconds: 3), () async{
          Navigator.pushReplacement(
            context,
            MaterialPageRoute(builder: (context) => LessonsResultsfranca()),
          );
        }
        );
      });
    ...
    if (_userAnswer.trim().toLowerCase() == '2t600b') {
      setState(() {
      ...
      firestoreService.markQuestionAsAnswered(userId, "françaQuiz", "Qual o PIB da França?");
      ...
      setState(() {
        _feedbackMessage = 'Resposta correta: 2T600B';
            ...
            child: Column(
              ...
              children: [
                ...
                Padding(
                  ...
                  child: Center(child: Text('Qual o PIB da França?',
