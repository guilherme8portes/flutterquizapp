...
class LessonsResultsfranca extends StatefulWidget {
  const LessonsResultsfranca({Key? key}) : super(key: key);

  @override
  State<LessonsResultsfranca> createState() => _LessonsResultsfrancaState();
}

class _LessonsResultsfrancaState extends State<LessonsResultsfranca> {
            ...
            child: Column(
              ...
              children: [
                ...
                Padding(
                  ...
                  child: Center(child: Text('Parabens, você concluiu o Quiz França!',
