...
import 'package:untitled2/quiz/fran%C3%A7a/quiz_franca_4.dart';
import '../../funcionalidades/exitalert.dart';
import '../0firestore/firestore_services.dart';

class QuizFranca3 extends StatefulWidget {


  @override
  _QuizFranca3State createState() => _QuizFranca3State();
}
class _QuizFranca3State extends State<QuizFranca3> {
  ...
  void _onVerifyAnswer() async {
    ...
    if (await firestoreService.isQuestionAnswered(userId, "françaQuiz", "Qual a empresa mais valiosa da França?")) {
      setState(() {
        _feedbackMessage = 'Você já respondeu essa pergunta corretamente antes!';
        Future.delayed(const Duration(seconds: 3), () async{
          Navigator.pushReplacement(
            context,
            MaterialPageRoute(builder: (context) => QuizFranca4()),
          );
        }
        );
      });
    ...
    if (_userAnswer.trim().toLowerCase() == 'louis vuitton') {
      setState(() {
      ...
      firestoreService.markQuestionAsAnswered(userId, "françaQuiz", "Qual a empresa mais valiosa da França?");
      ...
      setState(() {
        _feedbackMessage = 'Resposta correta: Louis Vuitton';
            ...
            child: Column(
              ...
              children: [
                ...
                Padding(
                  ...
                  child: Center(child: Text('Qual a empresa mais valiosa da França?',
