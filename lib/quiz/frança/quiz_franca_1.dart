...
import 'package:untitled2/quiz/fran%C3%A7a/quiz_franca_2.dart';
import '../../funcionalidades/exitalert.dart';
import '../0firestore/firestore_services.dart';

class QuizFranca1 extends StatefulWidget {


  @override
  _QuizFranca1State createState() => _QuizFranca1State();
}
class _QuizFranca1State extends State<QuizFranca1> {
  ...
  void _onVerifyAnswer() async {
    ...
    if (await firestoreService.isQuestionAnswered(userId, "françaQuiz", "Qual a Capital da França?")) {
      setState(() {
        _feedbackMessage = 'Você já respondeu essa pergunta corretamente antes!';
        Future.delayed(const Duration(seconds: 3), () async{
          Navigator.pushReplacement(
            context,
            MaterialPageRoute(builder: (context) => QuizFranca2()),
          );
        }
        );
      });
    ...
    if (_userAnswer.trim().toLowerCase() == 'paris') {
      ...
      firestoreService.markQuestionAsAnswered(userId, "françaQuiz", "Qual a Capital da França?");
            ...
            child: Column(
              ...
              children: [
                ...
                Padding(
                  ...
                  child: Center(child: Text('Qual a capital da França?',
