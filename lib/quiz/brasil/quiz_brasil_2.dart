...
class QuizBrasil2 extends StatefulWidget {


  @override
  _QuizBrasil2State createState() => _QuizBrasil2State();
}
class _QuizBrasil2State extends State<QuizBrasil2> {
  ...
  void _onVerifyAnswer() async {
    ...
    if (await firestoreService.isQuestionAnswered(userId, "brasilQuiz", "Qual a maior cidade do Brasil?")) {
      setState(() {
        _feedbackMessage = 'Você já respondeu essa pergunta corretamente antes!';
        Future.delayed(const Duration(seconds: 3), () async{
          Navigator.pushReplacement(
            context,
            MaterialPageRoute(builder: (context) => QuizBrasil3()),
          );
        }
        );
      });
    ...
    if (_userAnswer.trim().toLowerCase() == 'são paulo') {
      setState(() {
      ...
      firestoreService.markQuestionAsAnswered(userId, "brasilQuiz", "Qual a maior cidade do Brasil?");
      ...
      setState(() {
        _feedbackMessage = 'Resposta correta: São Paulo';
            ...
            child: Column(
              ...
              children: [
                ...
                Padding(
                  ...
                  child: Center(child: Text('Qual a maior cidade do Brasil?',
