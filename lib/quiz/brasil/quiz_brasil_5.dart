...
import 'package:untitled2/quiz/brasil/lesson_results.dart';
...
class QuizBrasil5 extends StatefulWidget {


  @override
  _QuizBrasil5State createState() => _QuizBrasil5State();
}
class _QuizBrasil5State extends State<QuizBrasil5> {
  ...
  void _onVerifyAnswer() async {
    ...
    if (await firestoreService.isQuestionAnswered(userId, "brasilQuiz", "Qual o PIB do Brasil?")) {
      setState(() {
        _feedbackMessage = 'Você já respondeu essa pergunta corretamente antes!';
        Future.delayed(const Duration(seconds: 3), () async{
          Navigator.pushReplacement(
            context,
            MaterialPageRoute(builder: (context) => LessonsResults()),
          );
        }
        );
      });
    ...
    if (_userAnswer.trim().toLowerCase() == '1t800b') {
      setState(() {
      ...
      firestoreService.markQuestionAsAnswered(userId, "brasilQuiz", "Qual o PIB do Brasil?");
      ...
      setState(() {
        _feedbackMessage = 'Resposta correta: 1 trilhão e 800 milhões';
            ...
            child: Column(
              ...
              children: [
                ...
                Padding(
                  ...
                  child: Center(child: Text('Qual o PIB do Brasil?',
