...
import 'package:untitled2/quiz/brasil/quiz_brasil_4.dart';
import '../../funcionalidades/exitalert.dart';
import '../0firestore/firestore_services.dart';

class QuizBrasil3 extends StatefulWidget {


  @override
  _QuizBrasil3State createState() => _QuizBrasil3State();
}
class _QuizBrasil3State extends State<QuizBrasil3> {
  ...
  void _onVerifyAnswer() async {
    ...
    if (await firestoreService.isQuestionAnswered(userId, "brasilQuiz", "Qual a população do Brasil?")) {
      setState(() {
        _feedbackMessage = 'Você já respondeu essa pergunta corretamente antes!';
        Future.delayed(const Duration(seconds: 3), () async{
          Navigator.pushReplacement(
            context,
            MaterialPageRoute(builder: (context) => QuizBrasil4()),
          );
        }
        );
      });
    ...
    if (_userAnswer.trim().toLowerCase() == '200 milhôes') {
      setState(() {
      ...
      firestoreService.markQuestionAsAnswered(userId, "brasilQuiz", "Qual a população do Brasil?");
      ...
      setState(() {
        _feedbackMessage = 'Resposta correta: 200 milhôes';
            ...
            child: Column(
              ...
              children: [
                ...
                Padding(
                  ...
                  child: Center(child: Text('Qual a população do Brasil?',
