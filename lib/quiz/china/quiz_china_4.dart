...
import 'package:untitled2/quiz/china/quiz_china_5.dart';
import '../../funcionalidades/exitalert.dart';
import '../0firestore/firestore_services.dart';

class QuizChina4 extends StatefulWidget {


  @override
  _QuizChina4State createState() => _QuizChina4State();
}
class _QuizChina4State extends State<QuizChina4> {
  ...
  void _onVerifyAnswer() async {
    ...
    if (await firestoreService.isQuestionAnswered(userId, "chinaQuiz", "Qual a população da China?")) {
      setState(() {
        _feedbackMessage = 'Você já respondeu essa pergunta corretamente antes!';
        Future.delayed(const Duration(seconds: 3), () async{
          Navigator.pushReplacement(
            context,
            MaterialPageRoute(builder: (context) => QuizChina5()),
          );
        }
        );
      });
    ...
    if (_userAnswer.trim().toLowerCase() == '1,41 bilhão') {
      setState(() {
      ...
      firestoreService.markQuestionAsAnswered(userId, "chinaQuiz", "Qual a população da China?");
      ...
      setState(() {
        _feedbackMessage = 'Resposta correta: 1,41 bilhão';
            ...
            child: Column(
              ...
              children: [
                ...
                Padding(
                  ...
                  child: Center(child: Text('Qual a população da China?',
