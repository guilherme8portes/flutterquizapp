...
import 'package:untitled2/quiz/china/lessons_results_china.dart';
import '../../funcionalidades/exitalert.dart';
import '../0firestore/firestore_services.dart';

class QuizChina5 extends StatefulWidget {


  @override
  _QuizChina5State createState() => _QuizChina5State();
}
class _QuizChina5State extends State<QuizChina5> {
  ...
  void _onVerifyAnswer() async {
    ...
    if (await firestoreService.isQuestionAnswered(userId, "chinaQuiz", "Qual o PIB da China?")) {
      setState(() {
        _feedbackMessage = 'Você já respondeu essa pergunta corretamente antes!';
        Future.delayed(const Duration(seconds: 3), () async{
          Navigator.pushReplacement(
            context,
            MaterialPageRoute(builder: (context) => LessonsResultsChina()),
          );
        }
        );
      });
    ...
    if (_userAnswer.trim().toLowerCase() == '17,7t') {
      setState(() {
      ...
      firestoreService.markQuestionAsAnswered(userId, "chinaQuiz", "Qual o PIB da China?");
      ...
      setState(() {
        _feedbackMessage = 'Resposta correta: 17,7T';
            ...
            child: Column(
              ...
              children: [
                ...
                Padding(
                  ...
                  child: Center(child: Text('Qual O PIB da China?',
