...
import 'package:untitled2/quiz/china/quiz_china_3.dart';
import '../../funcionalidades/exitalert.dart';
import '../0firestore/firestore_services.dart';

class QuizChina2 extends StatefulWidget {


  @override
  _QuizChina2State createState() => _QuizChina2State();
}
class _QuizChina2State extends State<QuizChina2> {
  ...
  void _onVerifyAnswer() async {
    ...
    if (await firestoreService.isQuestionAnswered(userId, "chinaQuiz", "Qual a maior cidade da China?")) {
      setState(() {
        _feedbackMessage = 'Você já respondeu essa pergunta corretamente antes!';
        Future.delayed(const Duration(seconds: 3), () async{
          Navigator.pushReplacement(
            context,
            MaterialPageRoute(builder: (context) => QuizChina3()),
          );
        }
        );
      });
    ...
    if (_userAnswer.trim().toLowerCase() == 'xangai') {
      setState(() {
      ...
      firestoreService.markQuestionAsAnswered(userId, "chinaQuiz", "Qual a maior cidade da China?");
      ...
      setState(() {
        _feedbackMessage = 'Resposta correta: Xangai';
            ...
            child: Column(
              ...
              children: [
                ...
                Padding(
                  ...
                  child: Center(child: Text('Qual a maior cidade da China?',
