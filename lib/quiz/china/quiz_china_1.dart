...
import 'package:untitled2/quiz/china/quiz_china_2.dart';
import '../../funcionalidades/exitalert.dart';
import '../0firestore/firestore_services.dart';

class QuizChina1 extends StatefulWidget {


  @override
  _QuizChina1State createState() => _QuizChina1State();
}
class _QuizChina1State extends State<QuizChina1> {
  ...
  void _onVerifyAnswer() async {
    ...
    if (await firestoreService.isQuestionAnswered(userId, "chinaQuiz", "Qual a Capital da China?")) {
      setState(() {
        _feedbackMessage = 'Você já respondeu essa pergunta corretamente antes!';
        Future.delayed(const Duration(seconds: 3), () async{
          Navigator.pushReplacement(
            context,
            MaterialPageRoute(builder: (context) => QuizChina2()),
          );
        }
        );
      });
    ...
    if (_userAnswer.trim().toLowerCase() == 'pequim') {
      setState(() {
      ...
      firestoreService.markQuestionAsAnswered(userId, "chinaQuiz", "Qual a Capital da China?");
      ...
      setState(() {
        _feedbackMessage = 'Resposta correta: Pequim';
            ...
            child: Column(
              ...
              children: [
                ...
                Padding(
                  ...
                  child: Center(child: Text('Qual a capital da China?',
