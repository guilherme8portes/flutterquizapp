...
import 'package:untitled2/quiz/china/quiz_china_1.dart';
import '../0firestore/firestore_services.dart';

class LoadingPageChina extends StatelessWidget {
  Future<void> setupQuiz(BuildContext context, String userId) async {
    ...
    await firestoreService.setupQuizQuestions(userId, "chinaQuiz");

    // Após a configuração das perguntas, navegue para a primeira página do quiz
    Navigator.pushReplacement(
      context,
      MaterialPageRoute(builder: (context) => QuizChina1()),
    );
  }
