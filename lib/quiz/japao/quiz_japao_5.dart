...
import 'package:untitled2/quiz/japao/lesson_results_japao.dart';
import '../../funcionalidades/exitalert.dart';
import '../0firestore/firestore_services.dart';

class QuizJapao5 extends StatefulWidget {


  @override
  _QuizJapao5State createState() => _QuizJapao5State();
}
class _QuizJapao5State extends State<QuizJapao5> {
  ...
  void _onVerifyAnswer() async {
    ...
    if (await firestoreService.isQuestionAnswered(userId, "japaoQuiz", "Qual o PIB do Japão?")) {
      setState(() {
        _feedbackMessage = 'Você já respondeu essa pergunta corretamente antes!';
        Future.delayed(const Duration(seconds: 3), () async{
          Navigator.pushReplacement(
            context,
            MaterialPageRoute(builder: (context) => LessonsResultsjapao()),
          );
        }
        );
      });
    ...
    if (_userAnswer.trim().toLowerCase() == '5t') {
      setState(() {
      ...
      firestoreService.markQuestionAsAnswered(userId, "japaoQuiz", "Qual o PIB do Japão?");
      ...
      setState(() {
        _feedbackMessage = 'Resposta correta: 5T';
            ...
            child: Column(
              ...
              children: [
                ...
                Padding(
                  ...
                  child: Center(child: Text('Qual o PIB do Japão?',
