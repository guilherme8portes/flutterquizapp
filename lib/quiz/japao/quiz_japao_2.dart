...
import 'package:untitled2/quiz/japao/quiz_japao_3.dart';
import '../../funcionalidades/exitalert.dart';
import '../0firestore/firestore_services.dart';

class QuizJapao2 extends StatefulWidget {


  @override
  _QuizJapao2State createState() => _QuizJapao2State();
}
class _QuizJapao2State extends State<QuizJapao2> {
  ...
  void _onVerifyAnswer() async {
    ...
    if (await firestoreService.isQuestionAnswered(userId, "japaoQuiz", "Qual a maior cidade do Japão?")) {
      setState(() {
        _feedbackMessage = 'Você já respondeu essa pergunta corretamente antes!';
        Future.delayed(const Duration(seconds: 3), () async{
          Navigator.pushReplacement(
            context,
            MaterialPageRoute(builder: (context) => QuizJapao3()),
          );
        }
        );
      });
    ...
    if (_userAnswer.trim().toLowerCase() == 'tóquio') {
      setState(() {
      ...
      firestoreService.markQuestionAsAnswered(userId, "japaoQuiz", "Qual a maior cidade do Japão?");
      ...
      setState(() {
        _feedbackMessage = 'Resposta correta: tóquio';
            ...
            child: Column(
              ...
              children: [
                ...
                Padding(
                  ...
                  child: Center(child: Text('Qual a maior cidade do Japão?',
