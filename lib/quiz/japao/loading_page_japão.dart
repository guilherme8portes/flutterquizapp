...
import 'package:untitled2/quiz/japao/quiz_japao_1.dart';
import '../0firestore/firestore_services.dart';

class LoadingPagejapao extends StatelessWidget {
  Future<void> setupQuiz(BuildContext context, String userId) async {
    ...
    await firestoreService.setupQuizQuestions(userId, "japaoQuiz");

    // Após a configuração das perguntas, navegue para a primeira página do quiz
    Navigator.pushReplacement(
      context,
      MaterialPageRoute(builder: (context) => QuizJapao1()),
    );
  }
