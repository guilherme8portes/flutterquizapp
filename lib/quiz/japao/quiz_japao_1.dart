...
import 'package:untitled2/quiz/japao/quiz_japao_2.dart';
import '../../funcionalidades/exitalert.dart';
import '../0firestore/firestore_services.dart';

class QuizJapao1 extends StatefulWidget {


  @override
  _QuizJapao1State createState() => _QuizJapao1State();
}
class _QuizJapao1State extends State<QuizJapao1> {
  ...
  void _onVerifyAnswer() async {
    ...
    if (await firestoreService.isQuestionAnswered(userId, "japaoQuiz", "Qual a Capital do Japão?")) {
      setState(() {
        _feedbackMessage = 'Você já respondeu essa pergunta corretamente antes!';
        Future.delayed(const Duration(seconds: 3), () async{
          Navigator.pushReplacement(
            context,
            MaterialPageRoute(builder: (context) => QuizJapao2()),
          );
        }
        );
      });
    ...
    if (_userAnswer.trim().toLowerCase() == 'tóquio') {
      ...
      firestoreService.markQuestionAsAnswered(userId, "japaoQuiz", "Qual a Capital do Japão?");
            ...
            child: Column(
              ...
              children: [
                ...
                Padding(
                  ...
                  child: Center(child: Text('Qual a capital do Japão?',
