...
class LessonsResultsjapao extends StatefulWidget {
  const LessonsResultsjapao({Key? key}) : super(key: key);

  @override
  State<LessonsResultsjapao> createState() => _LessonsResultsjapaoState();
}

class _LessonsResultsjapaoState extends State<LessonsResultsjapao> {
            ...
            child: Column(
              ...
              children: [
                ...
                Padding(
                  ...
                  child: Center(child: Text('Parabens, você concluiu o Quiz Japão!',
