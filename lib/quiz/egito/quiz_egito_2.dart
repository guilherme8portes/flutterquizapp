...
import 'package:untitled2/quiz/egito/quiz_egito_3.dart';
import '../../funcionalidades/exitalert.dart';
import '../0firestore/firestore_services.dart';

class QuizEgito2 extends StatefulWidget {


  @override
  _QuizEgito2State createState() => _QuizEgito2State();
}
class _QuizEgito2State extends State<QuizEgito2> {
  ...
  void _onVerifyAnswer() async {
    ...
    if (await firestoreService.isQuestionAnswered(userId, "egitoQuiz", "Qual a maior cidade do Egito?")) {
      setState(() {
        _feedbackMessage = 'Você já respondeu essa pergunta corretamente antes!';
        Future.delayed(const Duration(seconds: 3), () async{
          Navigator.pushReplacement(
            context,
            MaterialPageRoute(builder: (context) => QuizEgito3()),
          );
        }
        );
      });
    ...
    if (_userAnswer.trim().toLowerCase() == 'cairo') {
      setState(() {
      ...
      firestoreService.markQuestionAsAnswered(userId, "egitoQuiz", "Qual a maior cidade do Egito?");
      ...
      setState(() {
        _feedbackMessage = 'Resposta correta: Cairo';
            ...
            child: Column(
              ...
              children: [
                ...
                Padding(
                  ...
                  child: Center(child: Text('Qual a maior cidade do Egito?',
