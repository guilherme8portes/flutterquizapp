...
class LessonsResultsEGITO extends StatefulWidget {
  const LessonsResultsEGITO({Key? key}) : super(key: key);

  @override
  State<LessonsResultsEGITO> createState() => _LessonsResultsEGITOState();
}

class _LessonsResultsEGITOState extends State<LessonsResultsEGITO> {
            ...
            child: Column(
              ...
              children: [
                ...
                Padding(
                  ...
                  child: Center(child: Text('Parabens, você concluiu o Quiz Egito!',
