...
import 'package:untitled2/quiz/egito/quiz_egito_2.dart';
import '../../funcionalidades/exitalert.dart';
import '../0firestore/firestore_services.dart';

class QuizEgito1 extends StatefulWidget {


  @override
  _QuizEgito1State createState() => _QuizEgito1State();
}
class _QuizEgito1State extends State<QuizEgito1> {
  ...
  void _onVerifyAnswer() async {
    ...
    if (await firestoreService.isQuestionAnswered(userId, "egitoQuiz", "Qual a Capital do Egito?")) {
      setState(() {
        _feedbackMessage = 'Você já respondeu essa pergunta corretamente antes!';
        Future.delayed(const Duration(seconds: 3), () async{
          Navigator.pushReplacement(
            context,
            MaterialPageRoute(builder: (context) => QuizEgito2()),
          );
        }
        );
      });
    ...
    if (_userAnswer.trim().toLowerCase() == 'cairo') {
      ...
      firestoreService.markQuestionAsAnswered(userId, "egitoQuiz", "Qual a Capital do Egito?");
            ...
            child: Column(
              ...
              children: [
                ...
                Padding(
                  ...
                  child: Center(child: Text('Qual a capital do Egito?',
