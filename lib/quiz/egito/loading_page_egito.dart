...
import 'package:untitled2/quiz/egito/quiz_egito_1.dart';
import '../0firestore/firestore_services.dart';

class LoadingPageEgito extends StatelessWidget {
  Future<void> setupQuiz(BuildContext context, String userId) async {
    ...
    await firestoreService.setupQuizQuestions(userId, "egitoQuiz");

    // Após a configuração das perguntas, navegue para a primeira página do quiz
    Navigator.pushReplacement(
      context,
      MaterialPageRoute(builder: (context) => QuizEgito1()),
    );
  }
