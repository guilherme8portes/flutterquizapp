...
import 'package:untitled2/quiz/egito/quiz_egito_5.dart';
import '../../funcionalidades/exitalert.dart';
import '../0firestore/firestore_services.dart';

class QuizEgito4 extends StatefulWidget {


  @override
  _QuizEgito4State createState() => _QuizEgito4State();
}
class _QuizEgito4State extends State<QuizEgito4> {
  ...
  void _onVerifyAnswer() async {
    ...
    if (await firestoreService.isQuestionAnswered(userId, "egitoQuiz", "Qual a população do Egito?")) {
      setState(() {
        _feedbackMessage = 'Você já respondeu essa pergunta corretamente antes!';
        Future.delayed(const Duration(seconds: 3), () async{
          Navigator.pushReplacement(
            context,
            MaterialPageRoute(builder: (context) => QuizEgito5()),
          );
        }
        );
      });
    ...
    if (_userAnswer.trim().toLowerCase() == '104 milhões') {
      setState(() {
      ...
      firestoreService.markQuestionAsAnswered(userId, "egitoQuiz", "Qual a população do Egito?");
            ...
            child: Column(
              ...
              children: [
                ...
                Padding(
                  ...
                  child: Center(child: Text('Qual a população do Egito?',
